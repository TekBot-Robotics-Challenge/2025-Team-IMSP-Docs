...
<div style="display: flex; justify-content: center; gap: 20px;">
  <img src="./assets/test-three/Test3_Description_piece1.png" alt="Image 1" style="width: 300px; height: 200px;">
  <img src="./assets/test-three/Test3_Description2.png" alt="Image 2" style="width: 300px; height: 200px;">
</div>

<div style="text-align: center;">
  <img src="./assets/test-three/Test3_Description3.png" alt="Image centrée" style="width: 300px; height: 200px;">
</div>
...
1. A = 193 mm ; B = 88 mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15;
2. A = 205 mm ; B = 100mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15 mm;
3. A = 210 mm ; B = 105 mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15 mm;
...
- Sélection du plan de dessus comme plan d'esquisse ;
- Construction d'un rectangle de longeur 2*X et de largeur Y;
- Disposition d'un point sur l'horizontale distant de A mm du centre du rectangle précédent ;
- Carré centré en ce point et de côté 50mm;
- Création de deux points sur les longueurs haut et bas du 1er rectangle et distants de 6mm du centre du rectangle;
- Tracé d'une ligne droite reliant les deux derniers points et les milieurs des longueurs hauts et bas du carré;
- Création du point situé au milieu des deux lignes des deux rectangles devant être reliés. 
- Construction d'un Rectangle de longueur egale à la distance entre les deux lignes et de largeur 5mm
- Ajustement ( avec l'outil ajuster) des lignes en surplus de notre esquisse.
- Application des contraintes nécessaires jusqu'à ce que toutes les lignes deviennent noirs. 
...
- Application des contraintes d'angles de distances et de parallélisme
...
<iframe title="vimeo-player" src="https://player.vimeo.com/video/1096325022?h=ec37c4394a" width="640" height="360" frameborder="0" allowfullscreen></iframe>
...
<div style="text-align: center;">
  <img src="./assets/test-three/Test3_Entités_convertis.png" alt="Image centrée" style="width: 400px; height: 300px; margin = 30px;">
</div>
...
<div style="text-align: center;">
  <img src="./assets/test-three/Test3_Esquisse4.png" alt="Image centrée" style="width: 400px; height: 300px; margin = 30px;">
</div>
...
L'extrusion précédemment réalisé a engendré un surplus de matière (décrit ci-dessus) à l'objet. Et donc pour régler ça, nous allons convertir le contour du petit rectangle dans le plan de face et faire un enlèvement de matière : 
...
1. A = 193 mm ; B = 88 mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15 mm ;
...
<div style="text-align: center;">
  <img src="./assets/test-three/Test3_Masse2vraie_valeur.png" alt="Image centrée" style="width: 700px; height: 400px; margin: 30px;">
</div>
...
<div style="display: flex; justify-content: center; gap: 20px;">
  <img src="./assets/test-three/Test3_Erreur_reel.png" alt="Image 1" style="width: 400px; height: 300px; margin: 10px">
  <img src="./assets/test-three/T3err4.png" alt="Image 2" style="width: 400px; height: 300px; margin: 10px">
</div>
...
Après application des contraintes, on obtient l'esquisse montré précédemment (Les valeurs sont elles de la question b) : 
<div style="text-align: center;">
  <img src="./assets/test-three/Test3_Esquisse1real.png" alt="Image centrée" style="width: 500px; height: 400px; margin = 30px;">
</div>

Cette erreur fût également commise au niveau des autres esquisse ,puis les contraintes manquantes fûrent appliquées à chaque fois.

NB : Une manière assez simple de vérifier l'application de toutes les contraintes est d'analyser la couleur des lignes d'esquisse : noir pour une esquisse entièrement contrainte et bleu pour une esquisse sous contrainte.
...
Valeurs des variables | Masse de la pièce
--------------------- | -----
A = 193 mm ; B = 88 mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15mm ;| 1400.64grammes
A = 205 mm ; B = 100mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15mm  | 1651.40 grammes
A = 210 mm ; B = 105 mm ; W = B/2 mm ; X = A/4 mm ; Y = B+5.5 mm ; Z = B+15mm | 1760.41 grammes

## ✅Bilan global 

La modélisation de cette pièce à géométrie un peu complexe et dont l'utilité couvre bon nombre de domaines en dehors de la robotique était l'occasion pour nous d'appliquer les connaissances acquises lors des tests précédents en ce qui concerne la modélisation 3d. Par ailleurs, ce test nous a apporté une compétence cruciale en modélisation auquel on ne s'y attendais pas vraiment : La gestion des erreurs 😌. La fréquence des erreurs au cours de cette modélisation nous a permis d'apprendre à comprendre les erreurs de modélisation et à les corriger afin d'aboutir à une modélisation plus ou moins correcte. 

### 🔗Annexes 
Vidéo complete de la modélisation : 
<iframe title="vimeo-player" src="https://player.vimeo.com/video/1096327866?h=ec37c4394a" width="640" height="360" frameborder="0"    allowfullscreen></iframe>
...
<div style="display: flex; justify-content: center; gap: 20px;">
  <img src="./assets/test-three/Team.jpg" alt="Image centrée" style="width: 40vw; height: 50vh;">
</div>
